var title = "電費";
var question = "台電依照用電度數分段收取對應的電費，如下表：\n介於0~120度的部分，每度收取1.63元；\n介於121~330度的部分，每度收取2.10元；\n介於331~500度的部分，每度收取2.89元；\n介於501~700度的部分，每度收取3.94元；\n請設計電費計算系統，根據用電度數，計算應繳多少電費(四捨五入至整數位)。\n";
var array = [
    /*["夜市牛排", "200"],
    ["藥燉排骨", "120"],
    ["炸雞排", "60"],
